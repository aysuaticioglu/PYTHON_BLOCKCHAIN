...
# yeni block için Block sınıfına değerler gönderiliyor.
  yeni_block = ornekblokzinciri(sira=sira_artir,
    zaman_damgasi=datetime.now(),
...
"""
Bu uygulama ilk olarak blokzinciri için blok oluşturuyor.Blok içindenki bilgileri karıştırarak sha-256 algoritmasıyla bir hashe dönüştürüyor.
"""
